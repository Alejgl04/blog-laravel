            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
              <div class="">
                ...
                <p class="text-left">
                  ...
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius modi aspernatur facere unde eaque expedita! Eius fuga nam earum voluptatum labore, neque voluptatibus laudantium eveniet quae temporibus officia deserunt cupiditate.
                </p>
              </div>
              <div class="">
                ...
                <p class="mb-4">
                  <a href="#!" class="text-white-600">Sign IN</a>
                </p>
                <p class="mb-4">
                  <a href="#!" class="text-white-600">Sign UP</a>
                </p>
                <p class="mb-4">
